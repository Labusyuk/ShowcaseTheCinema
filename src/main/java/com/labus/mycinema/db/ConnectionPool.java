...
public class ConnectionPool {
    ...
    public static ConnectionPool getInstance() {
        if (!isCreated) {
            synchronized (ConnectionPool.class) {
                ...
                isCreated = true;
                logger.log(Level.INFO, "The connection pool was created");
            }
        }
        return poolInstance;
    }
    ...
    private void initPoolData() {
        ...
        for (int i = 0; i < poolSize; i++) {
            try {
                ...
                logger.log(Level.ERROR, "Error initial list of connections.");
            }
        }
    }
    ...
    public Connection takeConnection() throws SQLException {
        ...
        logger.log(Level.INFO, "Connection was taked. "+ connection.getClientInfo("myName"));
        return connection;
    }
    ...
    public void dispose() {
        ...
        logger.log(Level.INFO, "All connection was disposed.");
    ...
    private class PooledConnection implements Connection {
        ...
        public void close() throws SQLException {
            ...
            logger.log(Level.INFO, "Connection was returned. "+connection.getClientInfo("myName"));
        }
